...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		if(hasCrossedFinishLine()) {
			JOptionPane.showMessageDialog(null, "The robot finished, it traveled: "+ totalDistance);
			
		}else {
			JOptionPane.showMessageDialog(null,"The robot did not finish, it traveled: "+ totalDistance);
		}
