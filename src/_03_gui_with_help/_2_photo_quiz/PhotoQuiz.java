...
public class PhotoQuiz {
	...
	public void run() {
		...
		String question = JOptionPane.showInputDialog("what mountain is pictured here?");
		// 7. print "CORRECT" if the user gave the right answer
		if(question.equalsIgnoreCase("Mount Fuji")||question.equalsIgnoreCase("Mt. Fuji")) {
